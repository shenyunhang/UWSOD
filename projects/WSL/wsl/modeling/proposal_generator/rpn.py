...
from wsl.modeling.proposal_generator.proposal_utils import (
...
class StandardRPNHeadWSL(nn.Module):
    """
...
class RPNWSL(nn.Module):
    ...
    def forward(
        ...
        if self.mrrp_on and False:
            ...
            # Duplicate images and gt_instances for all branches in MRRPNet.
