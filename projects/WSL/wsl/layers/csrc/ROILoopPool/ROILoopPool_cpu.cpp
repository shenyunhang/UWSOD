...
std::tuple<at::Tensor, at::Tensor> ROILoopPool_forward_cpu(
  ...
  at::CheckedFrom c = "ROILoopPool_forward_cpu";
...
at::Tensor ROILoopPool_backward_cpu(
  ...
  at::CheckedFrom c = "ROILoopPool_backward_cpu";
